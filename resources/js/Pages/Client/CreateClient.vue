        ...
        <section class="pt-20">
            <div class="container mx-auto px-7">
                <div class="flex gap-x-4 items-center">
                    <div class="text-2xl font-normal">Add New Customer</div>
                    ...
                    <div class="flex gap-x-3 items-center">
                        ...
                        <div>-
                            ...
                            <span class="ml-3"> - Add New Customer</span>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="px-4">
                                ...
                                <div class="flex justify-between gap-x-8 mt-2">
                                    <div class="mt-1 w-full">
                                        ...
                                        <input v-model="form.password" class="w-full px-4 py-2 border border-gray-300 rounded-md text-gray-900 focus:outline-none mt-1 placeholder:text-sm"
                                               type="password" placeholder="Client password">
                                        <div v-if="form.errors.password" class="text-red-500 px-2 py-1 text-sm">{{ form.errors.password }}</div>
                                    </div>
                                    <div class="mt-1 w-full">
                                        <div class="required">Confirm Password</div>
                                        <input v-model="form.password_confirmation" class="w-full px-4 py-2 border border-gray-300 rounded-md text-gray-900 focus:outline-none mt-1 placeholder:text-sm"
                                               type="password" placeholder="Client confirm password">
                                        <div v-if="form.errors.password_confirmation" class="text-red-500 px-2 py-1 text-sm">{{ form.errors.password_confirmation }}</div>
                                    </div>
                                    <div class="mt-1 w-full">
...
export default {
    ...
    methods: {
        submit(){
            this.form.post(route('admin.client.store'),{
                preserveScroll: true,
                onSuccess: () => {
                    this.$swal.fire({
                        title: 'Success!',
                        text: 'Client and Business create successful',
                        icon: 'success',
